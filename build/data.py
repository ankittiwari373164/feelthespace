...
BEFORE_AFTER = [
    ...
    {"title": "Living Room", "where": "Greater Noida West",
     "note": "Plastered walls and bare doors transformed into a lit living space with mirror work and fitted storage.",
    ...
    {"title": "Hotel Room", "where": "Greater Noida West",
     "note": "Bare civil shell with unfinished window openings turned into a finished hotel bedroom with a plush headboard and drapes.",
     "before": "ba05-window-before", "after": "ba05-bedroom-after"},
    {"title": "Lobby Area", "where": "NX One, Greater Noida West",
     "note": "An unplastered brick-and-conduit passage finished into a tiled, lit hotel corridor.",
     "before": "ba06-corridor-before", "after": "ba06-corridor-after"},
    {"title": "Hotel Reception", "where": "Greater Noida West",
     "note": "A raw ceiling framework mid-construction becomes a grand reception lounge with a statement crystal chandelier.",
     "before": "ba08-reception-before", "after": "ba07-living-after"},
]
...
ALT = {
 ...
 "ba08-reception-before": "Raw ceiling framework mid-construction for a future crystal chandelier installation",
